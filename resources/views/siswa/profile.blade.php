							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{asset('admin/assets/img/avatar/'.$siswa->avatar)}}" width="150px" class="img-circle" alt="Avatar">
									...
									<div class="profile-stat">
										<div class="row">
											<div class="col-md-6 stat-item">
												{{$siswa->mapels->count()}}<span>Mata Pelajaran</span>
											</div>
											<div class="col-md-6 stat-item">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
										@foreach ($siswa->mapels as $data)
											<tr>
												<td>{{ $data->kode }}</td>
												<td>{{ $data->nama }}</td>
												<td>{{ $data->semester }}</td>
												<td>{{ $data->pivot->nilai }}</td>
												<td><a href="/guru/{{$data->id}}/profile">{{$data->guru->nama}}</a></td>
												<td><a href="/siswa/{{$siswa->id}}/{{$data->id}}/deletenilai" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Dihapus ?')">Delete</a></td>
											</tr>
										@endforeach
										</tbody>
									</table>
